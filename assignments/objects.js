...
const parent = {
  ...
  child: {
    ...
    age: 50,
    speak: function() {
      return `Child's name is ${this.name}`;
    },
    grandchild: {
      name: "Sam",
      age: 30,
      speak: function() {
        return `Grandchild's name is ${this.name}`;
      }
    }
  },
  speak: function() {
    return `Parent's name is ${this.name}`;
  }
};
...
console.log(
  `Grandchild's name&age: ${parent.child.grandchild.name} ${
