...
let lastCar = 0;
console.log(
  `The last car is ${inventory[inventory.length - 1].car_make} ${
...
console.log(`Car models alphabetically: ${carModelsSorted}`);
...
console.log(`BMW & Audis: ${JSON.stringify(BMWAndAudi)}`);
